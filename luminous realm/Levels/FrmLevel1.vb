Public Class FrmLevel1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        If FrmGame.game.Player.iscollidingwith(FrmGame.game.l1platform5.hitbox) And FrmGame.game.isActiveForm(Me) Then
        ...
        If FrmGame.game.Player.iscollidingwith(New Hitbox(PictureBox1)) And FrmGame.game.isActiveForm(Me) Then
            FrmGame.game.Player.intX = 0
            FrmGame.game.Player.intY = 350
        End If
    End Sub
End Class